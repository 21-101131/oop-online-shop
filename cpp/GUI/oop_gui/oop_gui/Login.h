...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			System::String^ inputString = "Hello, world!";
			this->label6->Text = gcnew System::String(inputString.c_str());
			...
			this->dataGridView1->Location = System::Drawing::Point(293, 138);
			this->dataGridView1->Name = L"dataGridView1";
			this->dataGridView1->RowHeadersWidth = 51;
			this->dataGridView1->RowTemplate->Height = 24;
			this->dataGridView1->Size = System::Drawing::Size(304, 248);
			this->dataGridView1->TabIndex = 45;
			this->dataGridView1->Visible = false;
			// 
			// Column1
			// 
			this->Column1->HeaderText = L"Price";
